...
const buttons = {
    ...
    confirmSubtract: document.querySelector('#subtractForm button[type="submit"]'), // Nama diubah agar lebih jelas
    confirmAdd: document.querySelector('#addForm button[type="submit"]') // Ditambahkan tombol konfirmasi modal tambah
};
...
// Fungsi setLoadingState ini sekarang hanya dipakai untuk tombol form utama,
// jadi kita biarkan saja, tapi tidak akan kita pakai di dalam submit modal.
...
// [PERUBAHAN 3] Event listener untuk modal Kurangi Stok
DOMElements.subtractForm.addEventListener('submit', async (e) => {
    ...
    // [MODIFIKASI] Terapkan loading state ke tombol modal
    buttons.confirmSubtract.disabled = true;
    buttons.confirmSubtract.innerHTML = '<span class="animate-pulse">Menyimpan...</span>';
    buttons.confirmSubtract.classList.add('opacity-50');
    ...
    try {
        ...
        // [MODIFIKASI] Kembalikan tombol modal ke normal
        buttons.confirmSubtract.disabled = false;
        buttons.confirmSubtract.innerHTML = originalText.confirmSubtract;
        buttons.confirmSubtract.classList.remove('opacity-50');
        
        resetFormButtons(); // Tetap reset tombol form utama
    }
});

// [PERUBAHAN 4] Event listener untuk form modal Tambah Stok
DOMElements.addForm.addEventListener('submit', async (e) => {
    ...
    // [MODIFIKASI] Terapkan loading state ke tombol modal
    buttons.confirmAdd.disabled = true;
    buttons.confirmAdd.innerHTML = '<span class="animate-pulse">Menyimpan...</span>';
    buttons.confirmAdd.classList.add('opacity-50');
    ...
    try {
        ...
        // [MODIFIKASI] Kembalikan tombol modal ke normal
        buttons.confirmAdd.disabled = false;
        buttons.confirmAdd.innerHTML = originalText.confirmAdd;
        buttons.confirmAdd.classList.remove('opacity-50');
