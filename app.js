...
// INI ADALAH BAGIAN YANG SEHARUSNYA BERJALAN
DOMElements.nameForm.addEventListener('submit', (e) => { 
    e.preventDefault(); 
    ...
    if (name) { 
        ...
        UI.closeModal(DOMElements.nameModal); 
    } 
});
...
DOMElements.productForm.addEventListener('submit', async (e) => {
    ...
    if (action === 'subtract') {
        ...
        DOMElements.subtractReason.value = ''; 
        ...
        DOMElements.addReason.value = ''; 
        UI.showModal(DOMElements.addModal);
    }
});

// [KODE YANG DIPERBAIKI 3]
